...
export const AgeConfirmationScreen: React.FC<AgeConfirmationScreenProps> = ({
    onConfirmed,
}) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.body}>
                Drink Aware helps you keep track of what you drink, at your
                own pace. It's not medical advice - just a helpful tool.
            </Text>
            <Pressable style={styles.confirmButton} onPress={handleConfirm}>
                <Text style={styles.confirmButtonText}>
                    I'm 18 or over - continue
                </Text>
            </Pressable>
            <Text style={styles.footnote}>
                By continuing you confirm you are aged 18 or over. This app
                does not provide medical advice. If you're concerned about 
                your drinking, please speak to your GP.
            </Text>
        </View>
    );
};
